...
const mockRegions: Region[] = [
  {
    ...
    order_index: 1,
    dataset_info: {
      features: ['年代', '職人技', '材質', '古色', '来歴', '芸術様式', '保存状態', '希少性'],
      classes: ['贋作', '本物'],
      samples: 500
    },
  ...
  },
  {
    ...
    order_index: 2,
    dataset_info: {
      features: ['材質', '装飾', '職人技', '価格', '耐久性', '希少性', '交易ルート', '文化的影響', '品質スコア', '市場価値', '交易効率'],
      classes: ['中国', '南蛮', '朝鮮', '日本'],
      samples: 600
    },
    created_at: new Date().toISOString()
  },
  {
    ...
    order_index: 3,
    dataset_info: {
      features: ['労働者数', '経験値', '技術レベル', '気温', '降水量', '湿度', '機具品質', '採掘技術', '安全対策', '鉱石品質', '採掘深度', '採掘容易さ', '市場価格', '投資額', '政治安定性', '季節', '労働効率', '天候効果', '技術効果', '地質効果'],
      samples: 800
    },
    created_at: new Date().toISOString()
  },
  {
    ...
    order_index: 4,
    dataset_info: {
      features: ['春気温', '夏気温', '秋気温', '冬気温', '春雨量', '夏雨量', '秋雨量', '冬雪量', '日照時間', '湿度', '台風数', '洪水', '干ばつ', '霜害', '土質', '土壌水分', '土壌pH', '土壌養分', '種子品質', '肥料', '灌漑', '害虫対策', '栽培技術', '労働力', '市場価格', '投資', '技術', '気温最適度', '雨量最適度', '日照最適度', '災害影響', '土壌効果', '技術効果', '経済効果'],
      samples: 1000
    },
    created_at: new Date().toISOString()
  },
  {
    ...
    order_index: 5,
    dataset_info: {
      features: ['年齢', '身長', '体重', '筋力', '持久力', '敏捷性', '器用さ', '知力', '記憶力', '反応速度', '集中力', '近接技能', '遠距離技能', '命中精度', '戦術理解', '戦闘経験', '訓練度', 'リーダーシップ', '規律性', '社会階級', '教育レベル', '軍人家系', '出身地域', '勇気', '忠誠心', '適応力', 'ストレス耐性', '健康状態', '負傷歴', '視力', '聴力', '年齢効果', '健康効果', '背景効果', '総合適性'],
  ...
  },
  {
    ...
    order_index: 6,
    dataset_info: {
      features: ['鉄品質', '鋼品質', '木材品質', '火薬品質', '鍛造技術', '穴あけ精度', 'ねじ切り精度', '研磨技術', '組み立て精度', '親方技能', '弟子技能', '経験年数', '注意力', '直線性', '密閉度', '引き金速度', '重量バランス', '耐久性', '射撃精度', '製造温度', '製造湿度', '工具品質', '作業環境', '検査厳密さ', 'テスト充実度', '規格遵守度', '材料スコア', '工程スコア', '技能スコア', '物理スコア', '環境スコア', '品質管理スコア', '材料効果', '技能効果', '工程効果', '材料技能相互作用', '工程環境相互作用', '品質管理効果', '総合品質', '信頼性', '一貫性', '市場価値'],
      classes: ['不良品', '良品'],
      samples: 1000
    },
    created_at: new Date().toISOString()
